...
export const RELAY_LEGAL_TEXT = [
  ...
  "Taşınan trafik internete çıkarılmaz. Tedbirge® WebOS bir internet dağıtıcısı, VPN veya vekil sunucu değildir; röle yalnız Tedbirge ağı içindeki iletim içindir.",
