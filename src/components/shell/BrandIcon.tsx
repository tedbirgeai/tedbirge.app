...
export function brandLogoUrl(domain: string): string {
  ...
  return `data:image/svg+xml,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><title>${label}</title><rect width="64" height="64" rx="16" fill="currentColor"/></svg>`)}`;
}
    ...
    case "youtube":
      return (
        <svg {...common} aria-hidden>
          ...
          <path d="M26 20l18 12-18 12z" fill="#fff" />
        </svg>
      );
    case "tiktok":
      return (
        <svg {...common} aria-hidden>
          ...
          <path d="M37 15c2 6 6 9 12 10v8c-5 0-9-2-12-5v13c0 8-6 13-14 13-7 0-12-5-12-12s6-12 13-12c1 0 2 0 3 .3v8.1c-1-.4-2-.6-3-.6-3 0-5 2-5 5s2 5 5 5 5-2 5-6V15z" fill="#25f4ee" />
          <path d="M40 18c2 4 5 6 10 7v7c-5 0-9-2-13-5v14c0 8-6 13-14 13-4 0-8-2-10-5 2 1 4 2 7 2 8 0 14-5 14-13V18z" fill="#fe2c55" opacity=".9" />
        </svg>
      );
    case "x":
      return (
        <svg {...common} aria-hidden>
          ...
          <path d="M18 16h9l8 11 10-11h5L37 31l14 17h-9l-9-12-11 12h-5l14-16zM24 20l21 24h2L26 20z" fill="#fff" />
        </svg>
      );
    case "linkedin":
      return (
        <svg {...common} aria-hidden>
          ...
          <path d="M17 26h9v24h-9zm4.5-11a5 5 0 110 10 5 5 0 010-10zM30 26h8v3c2-2 4-4 9-4 7 0 11 5 11 14v11h-9V40c0-5-2-7-5-7-4 0-5 3-5 7v10h-9z" fill="#fff" />
        </svg>
      );
    case "github":
      return (
    ...
    case "spotify":
      return (
        <svg {...common} aria-hidden>
          ...
          <path d="M20 25c8-3 19-2 25 2m-23 7c6-2 15-1 21 2m-18 7c5-1 11-.8 15 2" stroke="#06120a" strokeWidth="5" strokeLinecap="round" fill="none" />
        </svg>
      );
    case "whatsapp":
      return (
        <svg {...common} aria-hidden>
          ...
          <path d="M32 13a18 18 0 00-15 28l-2 9 9-2a18 18 0 108-35z" fill="#fff" />
          <path d="M25 22c-.5-1-1-1-2-1h-2c-.6 0-1 .2-1.5.8-1 1-2 2.5-2 5 0 7 7 14 15 17 6 2 9 1 11-1 .8-1 1.5-3 1.5-4s-.4-1-1-1.2l-6-2.8c-.8-.3-1.3-.2-1.8.5l-1.8 2.3c-.4.5-1 .6-1.7.3-4-1.8-7-4.4-8.7-8.2-.3-.7-.2-1.1.3-1.6l1.3-1.5c.4-.5.6-.8.8-1.4.2-.5.1-1-.1-1.4z" fill="#25d366" />
        </svg>
      );
    case "google":
      return (
        <svg {...common} aria-hidden>
          ...
          <path d="M51 33c0-1.4-.1-2.8-.4-4H32v8h10.6A10 10 0 0138 43l7 5c4-4 6-9 6-15z" fill="#4285f4" />
          <path d="M32 52c6 0 10-2 14-5l-7-5c-2 1-4 2-7 2-5 0-10-4-12-9l-7 5c3 7 10 12 19 12z" fill="#34a853" />
          <path d="M20 35a12 12 0 010-7l-7-5a20 20 0 000 17z" fill="#fbbc05" />
          <path d="M32 20c3 0 6 1 8 3l6-6c-4-3-8-5-14-5-9 0-16 5-19 12l7 5c2-5 7-9 12-9z" fill="#ea4335" />
        </svg>
      );
    case "duckduckgo":
      return (
        <svg {...common} aria-hidden>
          <rect width="64" height="64" rx="16" fill="#de5833" />
          <circle cx="32" cy="32" r="18" fill="#fff" />
          <path d="M24 31c1-7 5-12 10-12s8 4 7 11c4 1 7 3 7 7 0 5-6 9-15 9s-16-4-16-9c0-3 3-6 7-6z" fill="#f4c36a" />
          <circle cx="28" cy="31" r="2" fill="#111" /><circle cx="38" cy="31" r="2" fill="#111" />
          <path d="M31 35h7l-4 4z" fill="#de5833" />
        </svg>
      );
    default:
      return (
        <svg {...common} aria-hidden>
          ...
          <circle cx="32" cy="32" r="21" fill="color-mix(in srgb, var(--tb-accent) 18%, transparent)" stroke="var(--tb-accent)" strokeWidth="3" />
          <text x="32" y="38" textAnchor="middle" fontSize="18" fontWeight="700" fill="var(--tb-accent)">
...
export function BrandIcon({
  ...
  return (
    <span role="img" aria-label={`${label} yerel SVG logosu`} className="inline-grid place-items-center">
