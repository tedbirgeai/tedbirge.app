...
const DESC =
  "Tedbirge® WebOS'in kriptografik yetenekleri, Wassenaar Düzenlemesi kapsamındaki sınıflandırması, yasaklı ülke politikası ve son kullanıcı beyanı süreci.";
...
const classification = [
  ["Ürün", "Tedbirge® WebOS / Loop / Off-Grid — yalnızca yazılım (tek statik binary + SDK)"],
      ...
      <section className="relative overflow-hidden border-b border-border/60">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Tedbirge® WebOS güçlü şifreleme içeren bir yazılımdır ve bu nedenle çift kullanımlı
