...
/** Tedbirge® WebOS saha/telemetri API'si — OpenAPI 3.1 tanımı. */
export const OPENAPI_SPEC = {
  openapi: "3.1.0",
  info: {
    title: "Tedbirge® WebOS Saha API",
    version: "0.6a-turnkey",
    description:
      "Gerçek Tedbirge® WebOS düğümlerinin saha telemetrisini (RTT, throughput, paket kaybı) bildirdiği uç noktalar. İçerik veya kullanıcı verisi taşınmaz; yalnızca ölçüm metrikleri kabul edilir.",
    contact: { name: "Mehmet DİNÇ (Tedbirge® WebOS)", url: `${SITE_URL}/iletisim` },
