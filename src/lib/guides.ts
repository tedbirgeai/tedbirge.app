    ...
    sections: [
      {
        ...
        body: [
          "Tedbirge® WebOS tek statik bir çalıştırılabilir dosyadır. Node.js, CDN veya paket yöneticisi gerektirmez; kurulum, dosyayı hedef cihaza kopyalamaktan ibarettir.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Tedbirge® WebOS, taşınan veriyi AES-256-GCM ile parça parça şifreler ve hiçbir parçayı kalıcılaştırmaz. Faturalama ve telemetri için yalnızca iki değer tutulur: SHA-256 bütünlük özeti ve taşınan bayt sayısı.",
